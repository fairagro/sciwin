...
sidebar:
  order: 1
slug: 2.0/examples/workflow-creation
---
...
Therefore the command that created this arrow was `s4n connect my-workflow --from @inputs/speakers --to calculation/speakers`.
...
![created workflow](../../../../assets/2.0/workflow_01.svg)
