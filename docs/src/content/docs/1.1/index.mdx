...
template: splash
hero:
  tagline: SciWIn-Client helps scientists build, run, and publish complex
    computational workflows — making research more reproducible, scalable, and
    collaborative.
  image:
    file: ../../../assets/1.1/s4n_screenshot.png
  actions:
    - text: Installation
...
import workflow_simple from "../../../assets/1.1/simple_workflow.svg"
