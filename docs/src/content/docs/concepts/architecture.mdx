...
- **`rocrate`** reads, writes, and validates [RO-Crates](https://www.researchobject.org/ro-crate/), including the Provenance Run Crates `s4n execute run --rocrate` produces — see [Provenance & Publishing](provenance) for what those actually contain.
